			...
			<!­­ La partie principale ­­>
				<div class="main">
					...
					try {
						...
						$req =$id_con->prepare('SELECT id_subject, title, text, id_user, date, time FROM messages WHERE id_subject= :id_subject');
						$req -> execute(array('id_subject' => $_GET['id_subject']));
						$i = 0;
						$pre = "2";
